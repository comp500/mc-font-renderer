(function () {
	...
	*/
	...
	class FontRenderer {
	    ...
	    drawString(str, x = 0, y = 0, style = new FontStyle()) {
	    ...
	    drawStringFormatted(str, x = 0, y = 0, shadow = false) {
	        let currStr = "";
	    ...
	    drawStringFormattedShadow(str, x = 0, y = 0) {
